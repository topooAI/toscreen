...
const steps: AuditStep[] = [
  ...
  {
    id: "project-model-clip-source",
    command: npmCommand,
    args: ["run", "audit:project-model-clip-source"],
  },
  {
  ...
  {
    id: "timeline-track-origin",
    command: npmCommand,
    args: ["run", "audit:timeline-track-origin"],
  },
  {
    id: "timeline-lane-wrapping",
    command: npmCommand,
  ...
  {
    id: "timeline-clip-style",
    command: npmCommand,
    args: ["run", "audit:timeline-clip-style"],
  },
  {
    id: "phase1-handoff",
    command: npmCommand,
