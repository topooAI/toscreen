...
console.log(JSON.stringify({ status: 'ok', audits: [30,31,32,33,34,35], focusDepths: 6, instant: true, portableClipboard: true, projectAutoFocus: 'manual-generate-only', telemetryFallback: 'sidecar-authoritative-project-recovery' }));
