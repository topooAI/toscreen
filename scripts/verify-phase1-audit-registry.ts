...
const requiredAuditScripts = [
  ...
  "audit:project-model-clip-source",
  "audit:recordings",
  "audit:recording-asset-files",
  "audit:recording-session",
  "audit:recording-session-contract",
  "audit:editing-session",
  "audit:editing-product-integration",
  "audit:editing-project-tail",
  ...
  "audit:presentation",
  "audit:presentation-ui",
  "audit:focus-30-35",
  "audit:presentation-recording-contract",
